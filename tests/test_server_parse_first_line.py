...
def test_parse_first_line():
    ...
    line = "GET / HTTP/1.1"
    expected = {"verb": "GET", "resource": "/", "protocol": "HTTP/1.1"}
...
def test_parse_first_line_post():
    line = "POST / HTTP/1.1"
    expected = {"verb": "POST", "resource": "/", "protocol": "HTTP/1.1"}
    actual = parse_first_line(line)
    assert actual == expected
...
def test_parse_first_line_head():
    line = "HEAD / HTTP/1.1"
    expected = {"verb": "HEAD", "resource": "/", "protocol": "HTTP/1.1"}
    actual = parse_first_line(line)
    assert actual == expected
...
def test_parse_first_line_index():
    ...
    expected = {"verb": "GET", "resource": "/index.html", "protocol": "HTTP/1.1"}
    actual = parse_first_line(line)
    assert actual == expected
...
def test_parse_first_line_image():
    ...
    expected = {"verb": "GET", "resource": "/image.png", "protocol": "HTTP/1.1"}
    actual = parse_first_line(line)
    assert actual == expected
...
def test_parse_first_video():
    ...
    expected = {"verb": "GET", "resource": "/videos/video.mkv", "protocol": "HTTP/1.1"}
    actual = parse_first_line(line)
    assert actual == expected
